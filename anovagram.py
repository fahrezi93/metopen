...
pGamma = ['scale', 'auto', 1.0]   # nilai gamma untuk kernel non-linear (seperti rbf)
ik = 0                     # indeks untuk kernel (gunakan 'rbf' untuk gamma)
ic = 1                      # indeks untuk nilai C
ig = 1                      # indeks untuk nilai gamma
fs = False      # Seleksi fitur menggunakan ANOVA F-test
